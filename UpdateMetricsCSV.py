...
inputFile = pandas.read_csv("subscriptionname/azure_monitoring.csv", encoding='cp1252')
...
def WriteSupportedMetricsToFile():
    ...
    numpy.savetxt('subscriptionname/azure_monitoring.csv', arr, fmt = '%s', delimiter=",", encoding="utf-8")
